...
class Weather:
    def __init__(self, *, description, wind, temp, weather_ID, humidity,
                 temp_min, temp_max):
        ...
        self.temp_min = kelvin_to_fahrenheit(temp_min)
        self.temp_max = kelvin_to_fahrenheit(temp_max)
